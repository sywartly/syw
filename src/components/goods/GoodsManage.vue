<template>
    <div>
        <div style="margin-bottom: 5px;">
            <el-input v-model="name" placeholder="请输入客户名" suffix-icon="el-icon-search" style="width: 200px;"
                      @keyup.enter.native="loadPost"></el-input>
            <el-select v-model="storage" placeholder="请选择地区" style="margin-left: 5px;">
                <el-option
            ...
            <el-select v-model="goodstype" placeholder="请选择产品" style="margin-left: 5px;">
                <el-option
...
<!--            </el-table-column>-->
            <el-table-column prop="name" label="客户" width="250">
            </el-table-column>

            <el-table-column prop="count" label="邮箱1" width="250">
            </el-table-column>
            <el-table-column prop="remark" label="邮箱2" width="250">
            </el-table-column>
          <el-table-column prop="storage" label="地区" width="250" :formatter="formatStorage">
          </el-table-column>
          <el-table-column prop="goodstype" label="产品" width="250" :formatter="formatGoodstype">
          </el-table-column>
          <el-table-column prop="username" label="业务员" width="250" >
          </el-table-column>
        ...
        <el-dialog
            ...
            <el-form ref="form" :rules="rules" :model="form" label-width="80px">
                ...
                <el-form-item label="地区" prop="storage">
                    <el-col :span="20">
                ...
                <el-form-item label="产品" prop="goodstype">
                    <el-col :span="20">
                ...
                <el-form-item label="邮箱1" prop="count">
                    <el-col :span="20">
                        <el-input v-model="form.count"></el-input>
                    </el-col>
                </el-form-item>
                <el-form-item label="邮箱2" prop="remark">
                  <el-col :span="20">
